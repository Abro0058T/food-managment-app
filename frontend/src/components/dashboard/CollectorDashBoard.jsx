...
import { MdHistory, MdOutlineSettings, MdOutlineSpaceDashboard ,MdMap} from 'react-icons/md'
    ...
    <div className={style.app} >
                <div className={style.sideBar}>
                    ...
                    <div className={style.sideButtons}><MdHistory className={style.icons} />
                        ...
                        <div className={style.sideButtons}><MdMap className={style.icons} />  <Link to="settings">
